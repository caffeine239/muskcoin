...
static const unsigned int MAX_BLOCK_SIZE_GEN = MAX_BLOCK_SIZE/6;         // 250KB  block soft limit
...
static const int64 DUST_SOFT_LIMIT = 100000; // 0.001 TSLA
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0.00001 TSLA mininput
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 2882 / 250;
    }
